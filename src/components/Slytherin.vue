...
import slytherinImage from '@/assets/dashboard-views/slytherin_dashboard.jpg';

const imageURL = ref(slytherinImage);
</script>
...
<template>
  <div id="app">
    ...
    <img :src="imageURL" alt="Slytherin Dashboard Image">
  </div>
</template>
