...
import hufflepuffImage from '@/assets/dashboard-views/hufflepuff_dashboard.jpg';

const imageURL = ref(hufflepuffImage);
</script>
  ...
  <div id="app">
    <nav>
      <ul>
        ...
        <li><RouterLink to="/slytherin">Slytherin</RouterLink></li>
      </ul>
    </nav>

    <img :src="imageURL" alt="Hufflepuff Dashboard Image">
  </div>
</template>
